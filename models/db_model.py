...
db.define_table('gameTable',
    ...
    Field('gameLevel', type='integer', required=True, represent=lambda level: dic_gameLevel[level],
...
db.define_table('participant',
    ...
    Field('category', type='integer', notnull=True, default = 0,
          represent=lambda category: dic_category[category] or '【削除済み】',
    ...
    Field('decisionToPlayer', type='reference gameTable', writable=False, readable=False),
