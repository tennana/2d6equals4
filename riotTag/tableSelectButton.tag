<tableSelectButton>
	<div class="btn-group btn-block">
		<button class="btn btn-primary selectBtn" data-target="oneTableID" onclick={selectClick}>第一希望</button>
		<button class="btn selectBtn" data-target="twoTableID" onclick={selectClick}>第二希望</button>
	</div>
	<script>
